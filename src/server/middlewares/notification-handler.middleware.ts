...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order.create': { roles: ['business-owner', 'hr-manager'], key: 'order', tenantPath: [], userPath: [] },
  'Order.update': { roles: ['business-owner'], key: 'order', tenantPath: [], userPath: [] },
  'Product.create': { roles: ['hr-manager'], key: 'product', tenantPath: [], userPath: [] },
};
